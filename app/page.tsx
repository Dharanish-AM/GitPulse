    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#0A0F1C] text-white flex flex-col items-center justify-center selection:bg-cyan-500/30">
      ...
      <div className="relative z-20 flex flex-col items-center text-center p-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <Link
            href="https://github.com/marketplace/gitpulse-analytics"
            target="_blank"
            rel="noreferrer"
            className="group relative inline-flex items-center gap-3 px-8 py-3 rounded-full border-2 border-cyan-400/60 bg-gradient-to-r from-cyan-900/40 to-blue-900/40 text-white font-bold hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] hover:border-cyan-400"
          >
            ...
            <span className="tracking-wide">Install from GitHub Marketplace</span>
          </Link>
        </div>
